...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {class Toast {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__actions_deleteComponent__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions_editColComponent__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_sortable__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_collectionForm__ = __webpack_require__(19);
...
class Builder {
    ...
    static init() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__actions_deleteComponent__["a" /* default */].deleteComponent();
        __WEBPACK_IMPORTED_MODULE_3__actions_editColComponent__["a" /* default */].changeCol();
    ...
    static newFieldOptionsCollectionForm($newField) {
        ...
        collectionHolder.children('.form-group').each(function () {
            __WEBPACK_IMPORTED_MODULE_5__modules_collectionForm__["a" /* default */].addCloneFormDeleteLink(collectionHolder);
        });
        ...
        colInput.on('change', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res === 'valid') {
                        new __WEBPACK_IMPORTED_MODULE_0__CoreBundle_assets_scripts_modules_Toast__["a" /* default */]('Composant mis à jour', 'success', 'Succès', 5000);
                ...
                error: function (er) {
                    new __WEBPACK_IMPORTED_MODULE_0__CoreBundle_assets_scripts_modules_Toast__["a" /* default */]('Composant non mis à jour', 'danger', 'Une erreur s\'est produite...', 5000);
...
/* harmony default export */ __webpack_exports__["a"] = (EditColComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CoreBundle_assets_scripts_modules_FixCKEditor__ = __webpack_require__(12);
        ...
        $(document).on('click', '.aky-builder-component-header__edit', function () {
            ...
            fetch('/admin/builder/component/' + componentid + '/edit').then(function (res) {
                return res.text().then(function (response) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__CoreBundle_assets_scripts_modules_FixCKEditor__["a" /* default */].init();
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_ui_ui_widgets_sortable__ = __webpack_require__(15);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {class CollectionForm {
