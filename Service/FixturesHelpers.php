...
{
    private $componentTemplateRepository;
    private $componentFieldRepository;
    ...
    public function updateBdd($slug, $name, $shortDescription, $isContainer, $prototype, $componentFieldsValues)
    {
