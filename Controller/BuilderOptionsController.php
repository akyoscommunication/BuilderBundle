...
#[Route(path: '/admin/builder/options', name: 'builder_options')]
...
class BuilderOptionsController extends AbstractController
{
    ...
    public function index(BuilderOptionsRepository $builderOptionsRepository, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(BuilderOptionsType::class, $builderOptions, ['entities' => $entities]);
        ...
        return $this->render('@AkyosBuilder/builder_options/new.html.twig', ['builder_option' => $builderOptions, 'form' => $form->createView(),]);
    }
}
